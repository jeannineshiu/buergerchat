...
const TOPIC_ICON_PATHS: Record<string, string> = {
  ...
  // clock
  rente: "M12 6v6h4.5m4.5 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z",
  // home
  wohngeld:
...
// Compact suggestion pills (the ChatGPT/Gemini pattern): icon + short topic
// label, wrapping freely — seven topics would overwhelm as full-text cards.
// Clicking sends the full prompt; the label tells the user what to expect
// and the sent message appears in the chat right away.
    ...
    <div className="flex flex-wrap justify-center gap-2">
      {starters.map((starter) => (
        <button
          ...
          className="group flex items-center gap-2 rounded-full border border-zinc-200 bg-white px-3.5 py-2 text-sm font-medium text-zinc-700 shadow-sm transition hover:border-blue-300 hover:bg-blue-50 hover:text-blue-700 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-200 dark:hover:border-blue-500/60 dark:hover:bg-blue-500/10 dark:hover:text-blue-300"
        >
