...
```bash
cd backend && pip install -r requirements-dev.txt && python -m pytest tests/   # 100 tests
cd crawler && python -m pytest tests/                                          # 41 tests
cd frontend && npm test                                                        # 44 tests (vitest)
```
